...
2.  Bereite den Datensatz durch Preprocessing und das Umwandeln in eine DFM für die Analyse vor. Hinterfrage kritisch, welche Bereinigung- und Normalisierungsschritte du tatsächlich braucht.
```{r echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, error = FALSE}
...
3.  Schauen wir uns für eine erste Analyse an, bei welchem Sternzeichen es am mysteriösesten wird: Bei welchem Sternzeichen fällt am häufigsten das Stichwort "secret"?
```{r echo = FALSE, eval = FALSE, message = FALSE, warning = FALSE, error = FALSE}
