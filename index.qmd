...
-   Datensatz 2: Dataset of Indian Newspaper Horoscopes. Verfügbar unter CC BY-NC-SA 4.0 Lizenz via [Kaggle](https://www.kaggle.com/datasets/thedivtagguy/times-of-india-horoscopes-dec-2019-to-june-2021), Autor: Aman Bhargava. Edited by reducing the data set to the first 1,000 observations only.
...
<li><a href="tutorial/03-diktionaer.html"> Tutorial</a></li>
<li><a href="code/03-diktionaer.R" download="03-diktionaer.R"> R-Code</a></li>
</ul>
<p></p>
```
...
<li><a href="tutorial/04-topic-modeling.html"> Tutorial</a></li>
<li><a href="code/04-topic-modeling.R" download="04-topic-modeling.R"> R-Code</a></li>
</ul>
<p></p>
```
