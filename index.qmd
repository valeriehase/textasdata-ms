...
Datensatz 1: IMDb Top-Rated TV Series Dataset(Download-Link). Verfügbar unter MIT Lizenz via [Kaggle](https://www.kaggle.com/datasets/khushikhushikhushi/imdb-top-rated-tv-series-dataset).
...
read.csv2("data/data_tvseries.csv") %>%
  download_this(
    ...
    button_label = "Download TV Dataset",
    button_type = "default",
    has_icon = TRUE,
    icon = "fa fa-save"
  )
